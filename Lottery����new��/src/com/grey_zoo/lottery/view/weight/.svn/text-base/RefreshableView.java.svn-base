...
public class RefreshableView extends LinearLayout implements OnTouchListener {
	...
	/**
	 * 初始化操作，把下拉的隐藏等,这个onLayout是由父View触发当前View layout方法的时候, 的一个callback. 
	...
	//	System.out.println("发生触摸事件");
		...
		case MotionEvent.ACTION_MOVE:
			...
			System.out.println(headerLayoutParams.topMargin+"");
			System.out.println(hideHeaderHeight+"");
